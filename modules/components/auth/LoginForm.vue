...
const redirectPath = computed(() => {
  ...
  return isValidRedirect(queryRedirect)
    ? queryRedirect
    : isValidRedirect(savedRedirect)
      ? savedRedirect
      : "/";
});
    ...
    >
      ...
      >
        <UInput
          ...
          :ui="{
            root: 'w-full',
            base: 'bg-gray-50 border-gray-200 text-gray-900 focus:border-primary-600 focus:ring-primary-600',
          }"
        />
      </UFormField>
